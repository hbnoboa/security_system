...
class OccurrencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occurrence" do
    assert_difference("Occurrence.count") do
      post occurrences_url, params: { occurrence: { city: @occurrence.city, description: @occurrence.description, email: @occurrence.email, latitude: @occurrence.latitude, longitude: @occurrence.longitude, name: @occurrence.name, neighborhood: @occurrence.neighborhood, ocurrenceType: @occurrence.ocurrenceType, postalCode: @occurrence.postalCode, street: @occurrence.street, tel: @occurrence.tel, uf: @occurrence.uf } }
    end
  ...
  test "should update occurrence" do
    patch occurrence_url(@occurrence), params: { occurrence: { city: @occurrence.city, description: @occurrence.description, email: @occurrence.email, latitude: @occurrence.latitude, longitude: @occurrence.longitude, name: @occurrence.name, neighborhood: @occurrence.neighborhood, ocurrenceType: @occurrence.ocurrenceType, postalCode: @occurrence.postalCode, street: @occurrence.street, tel: @occurrence.tel, uf: @occurrence.uf } }
